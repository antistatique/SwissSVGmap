(function () {
        ...
        function (a, b, c) {
            switch (b.nodeType) {
                case 1:
                    ...
                    if (b.attributes && b.attributes.length > 0)for (var e = 0; e < b.attributes.length; e++) {
                        var f = b.attributes[e].nodeName, h = b.getAttribute(f);
                        d.setAttribute(f, h)
                    }
                    if (c && b.childNodes && b.childNodes.length > 0)for (e = 0; e < b.childNodes.length; e++)d.appendChild(document._importNodeFunc(a, b.childNodes[e], c));
                    return d;
                case 3:
    ...
    q(U, {isSuspended:function () {
        ...
        if (c == -1)throw"Unknown id passed to unsuspendRedraw: " + a;
    ...
    q(t, {getAttribute:function (a) {
        ...
        if (this._attached && this._passThrough && !this._handler._redrawManager.isSuspended())d = this._handler.sendToFlash("jsGetAttribute", [this._guid, false, false, a, b, true]); else if (j) {
    ...
    q(L, {_setupFlash:function () {
        ...
        if (this._embedType == "script" && a.indexOf("overflow:") == -1)a += "overflow: hidden;";
        return a
